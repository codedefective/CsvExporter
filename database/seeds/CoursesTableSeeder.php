    ...
    class CoursesTableSeeder extends Seeder{
        public function run(){
            $courses = [
                ...
                [
                    "course_name" => "BA Modern Languages With Business Management",
                ...
                [
                    "course_name" => "MSc International Politics",
                ...
                [
                    "course_name" => "BSc Philosophy, Logic And Scientific Method",
                    "university"  => "ESCP Europe (London)"
                ],
